...
ActiveRecord::Schema.define(version: 20160102154237) do
  ...
  add_index "likes", ["essay_id"], name: "index_likes_on_essay_id"
  ...
  add_index "subscriptions", ["essay_id"], name: "index_subscriptions_on_essay_id"
